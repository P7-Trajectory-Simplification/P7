...
class BasicAssertions(unittest.TestCase):
    def __init__(self, route: Route, simplified_route: Route):
        ...
        trajectory = route.trajectory # Original trajectory
        simplified_trajectory = simplified_route.trajectory # Simplified trajectory

        # Simplified trajectories should have fewer or equal points than the original
        ...
        # All points in simplified trajectory should be from the original trajectory
